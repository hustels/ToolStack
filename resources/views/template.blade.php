    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <i class="fa fa-bell fa-fw activity-indicator has-activity-indicator" ></i>  <i class="fa fa-caret-down"></i>
                    </a>
            ...
            <div class="navbar-default sidebar" role="navigation"> 
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-table fa-fw"></i> Backups<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/report/srvmast">Telvent & Global</a>
                                </li>
                                <li>
                                    <a href="/report/francia">Francia</a>
                                </li>
                                <li>
                                    <a href="/report/vicalvaro">Vicalvaro</a>
                                </li>
                                <li>
                                    <a href="/report/australia">Australia</a>
                                </li>
                                <li>
                                    <a href="/report/china"> China</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
